...
public class XPath{
    ...
    private XPath(String s, Reader reader ) /*throws XPathException*/ {
        try {
            ...
            //throw new XPathException(this, e);    // 2004.12.26 HAW-Ryan
    ...
    public String toString() {
        ...
        //return string_;
        return (string_ == null) ? generateString() : string_;
        // End
    }
    ...
    // 2004.12.28 HAW=Ryan may be comment out
    public Object clone() {
        ...
        /*throws XPathException*/ //, IOException
    {
        synchronized (cache_) {
            ...
            if (result == null) {
                //result = new XPath(xpathString);    // commented by HAW-Ryan 2004.12.22
				result = new XPath(xpathString, new InputStreamReader(new ByteArrayInputStream(xpathString.getBytes())) );
...
// é¿ã@â“ìÆëŒâû
//
// Revision 1.3  2005/02/07 08:43:44  ryan
