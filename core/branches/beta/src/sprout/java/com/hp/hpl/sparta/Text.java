/*
 * Text.java : based on Sparta by Hewlett-Packard Company.
 * 
 ...
 * A section of text in an element.  In XML this can be either CDATA or not:
 * the DOM model does not distinguish between the two encodings.
 * @version  $Id: Text.java 3385 2005-08-18 22:12:13Z go $
 * @author Go Takahashi
...
public class Text extends Node {
    ...
    {
        //throw new Error("Sorry, not implemented");    // 2004.12.24 HAW-Ryan
        return null;
    }
