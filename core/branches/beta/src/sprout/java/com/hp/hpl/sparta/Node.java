/*
 * Node.java : based on Sparta by Hewlett-Packard Company.
 * 
 ...
 * An XML node.
 * 
 * @version  $Id: Node.java 3385 2005-08-18 22:12:13Z go $
 * @author Go Takahashi
...
public abstract class Node{
    ...
    */
    ...
    //throws XPathException, IOException
    {
        ...
        try {
            ...
            if (xpath.charAt(slash + 1) == '@') {
                ...
                while (i.hasMoreElements()) {
                    ...
                    //String oldValue = element.getAttribute(attrName);    // commented by HAW-Ryan 2004.12.22
					String oldValue = element.getAttribute( null, attrName );
                    if( !value.equals(oldValue)){
                        // commented by HAW-Ryan 2004.12.22
                        //element.setAttribute(attrName, value);
						element.setAttribute( null, attrName, value );
                        changed = true;
                    }
                }
            } else {
        ...
        //} catch (DOMException e) {    // 2004.12.28 HAW-Ryan commented
		} catch (ParseException e) {      // 2004.12.28 HAW-Ryan added
            if( e.code == ParseException.NOT_FOUND_ERR )
    ...
    Element makeMatching(
        ...
        predicate.accept(new BooleanExprVisitor() {
            ...
            public void visit(AttrNotEqualsExpr a) /*throws XPathException*/ {
                ...
                //    a.getAttrName(),
                //    "not " + a.getAttrValue());
				newChild.setAttribute( null, a.getAttrName(), "not " + a.getAttrValue());
            }
			// 2004.12.27 HAW-Ryan commented throws XPathException            
            public void visit(AttrLessExpr a) /*throws XPathException*/ {
				...
				newChild.setAttribute( null, a.getAttrName(),
									Long.toString(Long.MIN_VALUE));
            }
			// 2004.12.27 HAW-Ryan commented throws XPathException            
...
// ŽÀ‹@‰Ò“®‘Î‰ž
//
// Revision 1.3  2004/12/29 02:27:37  ryan
