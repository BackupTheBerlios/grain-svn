...
public class TestRunner extends IApplication {
    ...
    public void start() {
        ...
        suite.addTest(new jp.grain.profile.doja.CharactorSequenceTest().suite());
        suite.addTest(new jp.grain.profile.doja.ButtonTest().suite());
        suite.addTest(new jp.grain.xforms.BlockTest().suite());
        suite.addTest(new jp.grain.profile.doja.FormViewImplTest().suite());
